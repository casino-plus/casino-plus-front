...
abstract class $PlayerCopyWith<$Res> {
  ...
  $Res call({int seat, String userId, String nickname, String iconUrl});
}
...
class _$_Player extends _Player {
  ...
  @override
  String toString() {
    return 'Player(seat: $seat, userId: $userId, nickname: $nickname, iconUrl: $iconUrl)';
  }
...
abstract class _Player extends Player {
  factory _Player(
      ...
      required String userId,
      required String nickname,
      required String iconUrl}) = _$_Player;
  _Player._() : super._();
